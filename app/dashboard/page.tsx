...
export default function Dashboard() {
  ...
  // Initialize progress sync and get tracking status
  const { isTracking, todayMinutes } = useProgressSync()
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                  ...
                  <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-4 border border-white/20 dark:border-gray-700/50 shadow-sm">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-gray-900 dark:text-white">{todayMinutes}min</div>
        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-600 dark:text-gray-400 text-sm">
              © 2026 TalkGenius. Elevating communication skills.
            </div>
