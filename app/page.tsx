    ...
    <div className="min-h-screen relative">
        ...
        <div className="bg-black/50 p-8 rounded-2xl">
          <h1 className="mb-6 font-space-grotesk text-5xl font-bold leading-tight md:text-6xl">
            ...
            <span className="inline-block min-w-[280px] text-left">
              <Typewriter 
                words={['Unstoppable', 'Dominant', 'Unbeatable', 'Persuasive']}
      ...
      >
        ...
        <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
            ...
            <Button size="lg" variant="outline" className="group bg-transparent dark:border-white dark:text-white dark:hover:bg-white dark:hover:text-black">
      ...
      <footer className="relative z-10 border-t border-border/50 px-6 py-12 bg-background">
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div>
              <h4 className="mb-4 font-semibold text-foreground">About Us</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><a href="#" className="hover:text-foreground transition-colors">About : TY, Computer Engineering, GP Pune ,411016</a></li>
                {/* <li><a href="#" className="hover:text-foreground transition-colors">Careers</a></li> */}
                <li><a href="#" className="hover:text-foreground transition-colors">Contact : nalawadesarthak2207@gmail.com</a></li>
              </ul>
            </div>
            <div>
              <h4 className="mb-4 font-semibold text-foreground">Team Tech-Yoddhas</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li><a href="#" className="hover:text-foreground transition-colors">Omkar Jagtap</a></li>
              </ul>
            </div>
          </div>
          <div className="mt-8 border-t border-border/50 pt-8 text-center text-sm text-muted-foreground">
            © 2026 TalkGenius. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
